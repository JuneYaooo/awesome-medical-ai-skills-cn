...
| [apple-health-analysis](https://github.com/labrinyang/apple-health-analysis) | Claude Code / Multi | ✅ 直接可用 | ![](https://img.shields.io/github/stars/labrinyang/apple-health-analysis?style=flat-square) 本地 Apple Health 导出分析技能。含 21 种统计方法、30 项疾病风险筛查、35+ SVG 图表与文献引用，支持中英文报告与 AI Agent 安装。 |
